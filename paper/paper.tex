...
Hyperspectral imaging has emerged as a keystone technology in remote sensing where the ability to discern slight variations in high resolution spectra facilitates a plethora of critical applications from land use assessment... etc. 
- environmental monitoring, resource management, risk assessment, biodiversity conservation, sustainable agriculture,
- Many hyperspectral remote sensing missions have already been launched with many more in development
    - EnMAP (launched 2022) is german satellite with remote sensing imager
    - PRISMA (launched 2019) is italian remote sensing satellite
    - HISUI (launched 2019) is japanese HSI on international space station
    - CHIME (future launch) - Copernicus Hyperspectral Imaging mission for the environment from the european space agency
    - SBG (future launch) - surface biology and geology - NASA mission
    - SHALOM (future launch) - Joint israeli-italian mission
    - HyspIRI (future launch) - italian missions
- Additionally, continued improvement to HSI technologies have dramatically reduced their size enabling their inclusion to the payloads of small unmanned aerial vehicles (UAV). 

- Key challenge: how to make sense of big data
- Common approaches involve computation of spectral indices like the NDVI
    - These are nice but can be challenging to compare between instruments due to varibility in spectral bands and sensor response
    - They also throw away
- A second common approach is to directly map spectral data to parameters of interest using in situ reference data 
    - This is popular for water quality assessment where parameters like CDOM, etc. track water quality
    - The key limitation is the availability of coincident reference data. This can requires decades of aligned observations to provide sufficient data volumes for statistical/machine learning models
- In light of these difficulties, unsupervised methods which extract relevant information from HSI themselves can be advantageous
...
- relevance to source apportionment in air quality monitoring
...
\begin{figure}[H]
\includegraphics[width=\columnwidth]{paper/figures/methods/robot-team/robot-team-overview.pdf}
...
\begin{figure}[H]
\includegraphics[width=\columnwidth]{paper/figures/results/usgs/fit-comparison.pdf}
\caption{Comparison of GSM against NMF on simulated USGS dataset. \label{fig:usgs-fits}}
\end{figure}  


\begin{figure}[H]
\includegraphics[width=\columnwidth]{paper/figures/results/usgs/extracted-endmembers.png}
...
\begin{figure}[H]
\includegraphics[width=0.60\columnwidth]{paper/figures/results/robot-team/pca-variance.png}
...
\begin{adjustwidth}{-\extralength}{0cm}
\centering
\includegraphics[width=1.25\columnwidth]{paper/figures/results/robot-team/extracted-endmembers.pdf}
\end{adjustwidth}
...
\begin{adjustwidth}{-\extralength}{0cm}
\centering
\includegraphics[width=\columnwidth]{paper/figures/results/robot-team/endmember-abundances.pdf}
...
\begin{adjustwidth}{-\extralength}{0cm}
\centering
\includegraphics[width=1.25\columnwidth]{paper/figures/results/robot-team/plume-evo.pdf}
\end{adjustwidth}
