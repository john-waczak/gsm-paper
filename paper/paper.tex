...
\end{equation}
where $\mathbf{z}=(z_1, z_2, ..., z_{N_v})$ corresponding to $N_v$-many sources and $\mathbf{W}$ is a $D \times M$ matrix of model weights which parameterize the mapping $\psi$.
