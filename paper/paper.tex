...
\end{figure}  
The extracted endmembers clearly fit the original source spectra while capturing local reflectance features. Additionally, the GSM precision parameter $\beta$ which is tuned during model training provides an assessment of spectral varaiibilty due to random noise. In Figure~\ref{fig:usgs-endmembers}
